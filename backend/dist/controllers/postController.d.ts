...
export declare const getPostArchive: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const getPostTags: (req: Request, res: Response) => Promise<void>;
