  ...
  return (
    <section className="relative min-h-[50vh] md:min-h-[70vh] flex items-center justify-center pt-16 px-4 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto space-y-4 md:space-y-6">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 pt-3 md:pt-4 animate-fade-in-up animation-delay-300">
          <a
            href="/projects"
            className="px-5 py-2 md:px-6 md:py-2.5 rounded-full bg-indigo-600/60 text-white text-sm md:text-base font-medium hover:bg-indigo-700 transition-all duration-300 hover:scale-105 shadow-lg shadow-indigo-500/10"
          >
            查看项目
          </a>
          <a
