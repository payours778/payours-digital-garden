...
export function FooterInfo() {
  ...
  return (
    <div className="rounded-3xl surface-card backdrop-blur-xl border border-theme shadow-sm overflow-hidden">
      <div className="p-3 md:p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-4">
        <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
          ...
          <div className="text-xs md:text-sm text-secondary">
            ...
            系统已稳定运行：<span className="font-bold text-accent">{runningDays}天</span>
          </div>
        </div>
        <div className="flex items-center gap-2 md:gap-4 text-xs md:text-sm text-secondary flex-wrap">
          <div className="flex items-center gap-1 px-2 md:px-3 py-1 rounded-full surface-card">
