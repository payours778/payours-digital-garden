    ...
    <div className="rounded-3xl surface-card backdrop-blur-xl border border-theme shadow-sm overflow-hidden h-full">
      <div className="p-4 md:p-6 h-full flex flex-col justify-between">
        <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
          <div className="w-16 h-16 md:w-24 md:h-24 rounded-2xl overflow-hidden shadow-lg flex-shrink-0">
            <img
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-lg md:text-2xl font-bold text-primary mb-1 truncate">
              {currentTrack.title}
            </div>
            <div className="text-xs md:text-sm text-tertiary truncate">
              {currentTrack.artist}
            </div>
          </div>
        </div>
        <div className="text-xs md:text-sm text-tertiary mb-3 md:mb-4">
          点击播放
        </div>
        <div className="space-y-3 md:space-y-4">
          <div className="flex items-center gap-2 text-xs text-tertiary">
            <span>{formatTime(currentTime)}</span>
            <div className="flex-1 h-2 md:h-3 surface-track rounded-full overflow-hidden">
              <div 
          ...
          <div className="flex items-center justify-center gap-3 md:gap-4">
            <button 
              onClick={handlePrev}
              className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center text-secondary hover:text-accent transition-colors"
            >
