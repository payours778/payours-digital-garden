      ...
      <div className="p-4 md:p-6 h-full flex flex-col justify-between">
        <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-lg md:text-2xl font-bold text-slate-800 dark:text-white mb-1 truncate">
              {currentTrack.title}
            </div>
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
            ...
            <div className="flex-1 h-2 md:h-3 bg-white/30 dark:bg-white/10 rounded-full overflow-hidden">
              <div 
          ...
          <div className="flex items-center justify-center gap-3 md:gap-4">
            <button 
              onClick={handlePrev}
              className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
            >
